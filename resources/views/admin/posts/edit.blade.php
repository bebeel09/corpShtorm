                ...
                <div class="box-body">
                    <form>
                        <div class="form-group">
                            <h5>Заголовок</h5>
                            <div class="controls">
                                <input type="text" name="postTitle" class="form-control" required="" value="{{$item->title}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>Текст поста</h5>
                            <textarea id="summernote" name="editor1" rows="20" cols="80">{{$item->content_html}}</textarea>
                        </div>
                    </form>
                </div>
            </div>
