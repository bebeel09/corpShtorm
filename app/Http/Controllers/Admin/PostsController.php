...
class PostsController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.posts.edit', compact('item', 'categoryList', 'types'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($result) {
            return Response::json(['url' => route('blog.posts.index')."/".$category[0]->slug."/".Str::slug($data['title']),
                                    'msg' => 'Успешно сохранено'], 200);
        }else{
            return Response::json(['url' => route('blog.posts.index')."/".$category[0]->slug."/".Str::slug($data['title']),
                                    'msg' => 'Что-то пошло не так'], 200);
        }
    }
